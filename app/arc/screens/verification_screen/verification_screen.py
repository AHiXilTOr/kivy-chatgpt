...
Builder.load_file(os.path.join(os.path.dirname(__file__), "verification_screen.kv"))


class VerificationScreen(Base):
    def verification(self):
        ...
        if len(code) != 6:
            ...
            self.ids.error.text = "[color=e01c37]Неверный код[/color]"
            return
    ...
    async def response(self, params):
        ...
        self.ids.verification_button.disabled = True
        ...
        try:
            ...
            self.ids.verification_button.disabled = False
